  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="query.name" placeholder="学号/班级/姓名" class="handle-input mr10"></el-input>
      ...
      >
        ...
        <el-table-column prop="id" label="学号" width="105" align="center"></el-table-column>
...
<script>
import {listStudents} from "../api/index";
...
export default {
  ...
  methods: {
    // 获取 easy-mock 的模拟数据
    getData() {
      listStudents(this.query).then(res => {
        console.log(res);
